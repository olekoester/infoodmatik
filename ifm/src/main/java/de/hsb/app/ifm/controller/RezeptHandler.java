	...
	public void init() {
		...
		if (firstExecute) {
			...
			em.persist(new Rezept("Bandnudeln mit frischem Spinat und Lachs", "600 g Bandnudeln \n 500g Blattspinat \n 1 Zwiebel \n 2 Zehen Knoblauch \n 1TL Gemüsebrühe \n 125 ml Wasser \n 1 Pkt. Lachs geräucherter \n 1 Becher \n 1 TL Speisestärke \n 2 EL Rapsöl \n 1 Prise Salz Pfeffer und Muskat", 
					"1.Schritt: Die Nudeln nach Gebrauchsanweisung kochen - Achtung, frische Nudeln brauchen nur 2 - 3 Minuten (also aufs Timing achten)! \n 2.Schritt: ie Zwiebel in Ringe schneiden, in eine Pfanne mit hohem Rand und Deckel mit dem Öl geben und bei kleiner bis mittlerer Hitze glasig dünsten (nicht braten!). \n 3.Schritt: Gemüsebrühe mit Wasser mischen und dazu gießen (alternativ geht auch Weißwein statt Brühe). \n 4.Schritt: Den Knoblauch schälen, in möglichst kleine Stückchen schneiden und in die Pfanne geben. \n 5.Schritt: Nun den Spinat dazugeben. Evtl. geht das nur nach und nach, er fällt aber schnell in sich zusammen, so dass nachgelegt werden kann, falls die Pfanne nicht groß genug ist. \n 6.Schritt: Den Räucherlachs in Stücke schneiden und dazugeben, sobald der Spinat komplett in sich zusammen gefallen ist. \n 7.Schritt: Alternativ zum Räucherlachs geht auch frischer Lachs, der auf die gleiche Weise einfach gewürfelt und noch roh dazugegeben werden kann. \n 8.Schritt: Etwas Flüssigkeit abnehmen und in einer Tasse mit der Stärke mischen, bis sie sich löst. \n 9.Schritt: Dieses Gemisch wieder in die Pfanne geben, ebenso den Becher Cremefine bzw. Schmand. \n 10.Schritt: Mit Pfeffer, Salz und (am besten frisch hinein geriebener) Muskatnuss würzen, die Nudel abgießen und untermischen und servieren. \n","Fisch"));
